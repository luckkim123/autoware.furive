...
print_help() {
    ...
    echo "  --ksm           Enable KSM (Kernel SamePage Merging)"
...
build_images() {
    ...
    # Additional environment variables and tags can be adjusted here as needed
